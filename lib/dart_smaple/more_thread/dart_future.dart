...
void main() {
  ...
  Future.microtask(() {
    print('microtask1 可以看除 先运行microtask 对列中的消息');
  });
  new Future(() {
    print("3");
  });
  Future.microtask(() {
    print('microtask2 可以看除 先运行microtask 对列中的消息');
  });
  /**
   * Future 的常用函数
...
//在async await中，被await标记的是一个event。
Future<String> login() async {
  return await "test async await";
}
